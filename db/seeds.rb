...
t1 = Task.create(name: Faker::Marketing.buzzwords, description: Faker::Lorem.paragraph, category_id: c1.id, created_by: u1.username, position: 1000)
t2 = Task.create(name: Faker::Marketing.buzzwords, description: Faker::Lorem.paragraph, category_id: c1.id, created_by: u2.username, position: 2000)
t3 = Task.create(name: Faker::Marketing.buzzwords, description: Faker::Lorem.paragraph, category_id: c2.id, created_by: u2.username, position: 1000)
t4 = Task.create(name: Faker::Marketing.buzzwords, description: Faker::Lorem.paragraph, category_id: c3.id, created_by: u4.username, position: 1000)
