...
t7 = Task.create(name: "Little Italy Pizzeria", description: "11712 San Vicente Blvd Los Angeles, CA 90049 (310) 481-7108", category_id: c2.id, created_by: u1.username, position: 1)
t7a = Task.create(name: "The Steakhouse", description: "123 Lorem Ipsum Blvd Los Angeles, CA 90049", category_id: c2.id, created_by: u4.username, position: 2)
t7b = Task.create(name: "Lucky Chinese", description: "123 Lorem Ipsum Blvd Los Angeles, CA 90049 ", category_id: c2.id, created_by: u4.username, position: 3)
t7c = Task.create(name: "Ice Cream Parlor", description: "123 Lorem Ipsum Blvd Los Angeles, CA 90049", category_id: c2.id, created_by: u4.username, position: 4)
...
t11 = Task.create(name: Faker::Marketing.buzzwords, description: Faker::Lorem.paragraph, category_id: c6.id, created_by: u1.username, position: 1)
...
tl3 = TaskLabel.create(task_id: t6.id, label_id: l4.id)
